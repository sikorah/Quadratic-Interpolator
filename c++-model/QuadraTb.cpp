...
int main (int argc, char *argv[])
{
    ...
    cout << "Rozpoczynam test RTL vs C++..." << endl;
    
    bool ok_sts = true;
    ok_sts &= testFunction();
    
    if (ok_sts) {
        cout << "\n[SUKCES] Testy zakonczone pomyslnie! " 
             << "Blad we wszystkich przypadkach jest mniejszy niz dopuszczalny prog." << endl;
    } else {
        cout << "\n[PORAZKA] Znaleziono bledy." << endl;
    }
